...
import { Controller, Post, UnauthorizedException, HttpCode, HttpStatus, UseGuards } from '@nestjs/common';
...
let AuthController = (() => {
    ...
    var AuthController = class {
        ...
        static {
            ...
            _login_decorators = [HttpCode(HttpStatus.OK), Post('login')];
            _register_decorators = [Post('register')];
            _logout_decorators = [UseGuards(JwtAuthGuard), Post('logout')];
