...
__decorate([
    ...
    (0, check_policies_decorator_js_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_js_1.Action.Create, 'Category')),
    (0, common_1.Post)(),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_js_1.JwtAuthGuard, policies_guard_js_1.PoliciesGuard),
    (0, check_policies_decorator_js_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_js_1.Action.Update, 'Category')),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_js_1.JwtAuthGuard, policies_guard_js_1.PoliciesGuard),
    (0, check_policies_decorator_js_1.CheckPolicies)((ability) => ability.can(casl_ability_factory_js_1.Action.Delete, 'Category')),
